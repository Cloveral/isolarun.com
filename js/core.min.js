...
a.$doc.trigger("scroll");a.$win.load(function(){a.$win.trigger("resize");a.$win.trigger("orientationchange");return a.$doc.trigger("scroll")})};c.prototype.moveLayer=function(a){var f,b,e,q,g,h,c,k;if(null!=(b=a.getAttribute(a.$element[0],"on"))&&"true"!==b)d(this).css({"-webkit-transform":"none",transform:"none"});else{c=a.$win.scrollTop();g=a.$element.offset().top;k=a.$win.height();b=a.$element.height();e=a.$doc.height();q=this.offsetHeight;parseFloat(h);h=("inverse"===a.getAttribute(this,"direction")?
-1:1)*Math.min(parseFloat(a.getAttribute(this,"speed")),2);this.getAttribute("data-agent");null!=(f=this.getAttribute("data-agent"))?e=(f=d(f)).length?(g+k-(f.offset().top+k))/(k-b):.5:"media"!==this.getAttribute("data-type")?g<k||g>e-k?(e=g<k?g/(k-b):(g+k-e)/(k-b),isFinite(e)||(e=0)):e=.5:e=.5;if(l)return h=(b-q)/2,d(this).css(a.transform(h,a));h=-(g-c)*h+(b-q)/2+(k-b)*e*h+parseInt(a.getAttribute(this,"offset"));if(c+k>=g&&c<=g+b||"true"===this.getAttribute("data-unbound"))return d(this).css(a.transform(h,
a))}};c.prototype.moveCanvas=function(a,f){var b,e,c;b=d(this);c=a.$win.scrollTop();e=a.$element.offset().top;e=a.$anchor?a.$element.position().top:e-c;return b.css({top:e})};c.prototype.fadeLayer=function(a,f){var b,e,c,g,h;c=d(this);b=a.$element.height();e=a.$element.offset().top+b/2;g=c.offset().top+c.height()/2;h=b/6;if(e+h>g&&e-h<g)return c.css({opacity:1});b=e-h<g?1+(e+h-g)/b/3*10:1-(e-h-g)/b/3*10;return c.css({opacity:0>b?0:1<b?1:b.toFixed(2)})};c.prototype.blurMedia=function(a){var f,b,e,
c;f=this.offsetHeight;c=this.offsetWidth;b=parseFloat(this.getAttribute("data-media-height"));e=parseFloat(this.getAttribute("data-media-width"));f=Math.ceil(Math.max(f/b,c/e));return d(this).css(a.blur(f))};c.prototype.resizeMedia=function(a){return this.style.height=a.px(a.getMediaHeight(a.$win.height(),a.$element.height(),a.getAttribute(this,"speed"),"inverse"===a.getAttribute(this,"direction")?-1:1))};c.prototype.resizeWrap=function(a){return this.style.height=a.px(a.$canvas.outerHeight())};c.prototype.resizeCanvas=
function(a){return d(this).css({position:p&&a.$anchor?"relative":"fixed",left:p?"auto":a.$anchor?a.$element.offset().left-a.$anchor.offset().left:a.$element.offset().left,width:a.$element.width()})};c.prototype.fitCanvas=function(a){return setTimeout(function(){return a.$canvas.css({height:a.$element.parent().parent().height()})})};c.prototype.getMediaHeight=function(a,c,b,e){b=Math.max(parseFloat(b),0);b=Math.min(parseFloat(b),2);return c+(-1===e?(c+a)*b:0)+(1>=b?Math.abs(a-c)*b:a*b)+56};c.prototype.url=
function(a){return"url("+a+")"};c.prototype.px=function(a){return a+"px"};c.prototype.transform=function(a,c){return{"-webkit-transform":"matrix3d(1,0,0.00,0,0.00,1,0.00,0,0,0,1,0,0,"+a+",0,1)",transform:"matrix3d(1,0,0.00,0,0.00,1,0.00,0,0,0,1,0,0,"+a+",0,1)"}};c.prototype.blur=function(a){return 3<a?{"-webkit-filter":"blur("+a+"px)",filter:"blur("+a+"px)"}:{filter:"none","-webkit-filter":"none"}};c.prototype.getAttribute=function(a,c){var b,e,d,g,h;if(null!=this.options.screenAliases)for(e=Object.keys(this.options.screenAliases).reverse(),
d=g=0,h=e.length-1;(0<=h?g<=h:g>=h)&&!(b=""!==this.options.screenAliases[e[d]]?"-"+this.options.screenAliases[e[d]]:this.options.screenAliases[e[d]],b=a.getAttribute("data"+b+"-"+c),e[d]<=this.$win.width()&&null!=b);d=0<=h?++g:--g);return null!=b?b:this.options[c]};return c}();d.fn.extend({RDParallax:function(c){return this.each(function(){var a;a=d(this);if(!a.data("RDParallax"))return a.data("RDParallax",new n(this,c))})}});return m.RDParallax=n})(window.jQuery,document,window);"undefined"!==typeof module&&
